...
function createOverlay() {
  ...
  style.textContent = `
   ...
   #eq-modal{background:#fff;border-radius:20px;width:100%;max-width:560px;max-height:90vh;overflow-y:auto;padding:32px 28px 32px 28px;position:relative;animation:eqSlideUp 0.3s ease;box-shadow:0 20px 60px rgba(0,0,0,0.25)}
    #eq-close{position:absolute;top:12px;right:12px;background:transparent;color:#fff;border:none;border-radius:0;width:auto;height:auto;font-size:18px;cursor:pointer;color:#333;transition:color 0.2s;font-family:inherit;box-shadow:none;outline:none}
