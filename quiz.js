...
#eq-close{position:fixed;top:12px;right:12px;background:transparent;color:#fff;border:none;border-radius:0;width:auto;height:auto;font-size:18px;cursor:pointer;color:#333;transition:color 0.2s;font-family:inherit;box-shadow:none;outline:none}
