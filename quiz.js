...
function createOverlay() {
  ...
  style.textContent = `
   ...
   #eq-close{position:absolute;top:8px;left:16px;background:transparent;border:none;border-radius:0;width:auto;height:auto;font-size:18px;cursor:pointer;color:#333;transition:color 0.2s;font-family:inherit;box-shadow:none;outline:none}
